...
, CONSTRAINT FK_KLUB_EKIPA FOREIGN KEY (ID_KLUB) REFERENCES KLUB (ID) ON DELETE CASCADE
);
...
, CONSTRAINT FK_SUDAC_LISTA FOREIGN KEY (ID_SUDAC) REFERENCES SUDAC (ID) ON DELETE CASCADE
