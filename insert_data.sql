...
insert into rangsuca values (1, 'Nacionalni');
insert into rangsuca values (2, 'Gradski');
insert into rangsuca values (3, 'Županijski');


insert into ulogasuca values (1, 'Prvi sudac');
...
insert into ekipa values (1, 'Liverpool U17', 1, 1);
...
insert into natjecanje values (1, 'Premier League', (TO_DATE('2003/08/21', 'yyyy/mm/dd')), (TO_DATE('2004/05/13', 'yyyy/mm/dd')), ' 2003/2004', 1);
...
insert into utakmica values (1, (TO_DATE('2003/08/21', 'yyyy/mm/dd')), 1, 1, 2);
...
insert into sudac values (1, 'Mike', 'Dean', (TO_DATE('1989/03/21', 'yyyy/mm/dd')), '092 803 94 56', 'Halinčeva 4.', 1, 10000, 10000);
...
insert into sudenje values (1, 1, 1, 0);
